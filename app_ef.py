...
st.title("📚 Sube cualquier PDF que tengas. Nosotros lo analizamos. " + USER)
...
st.subheader("Aquí puedes realizar cualquier pregunta que tengas sobre tu archivo pdf:")
